...
// For instance:
// - Hero: "OpenUser helps developers launch startups fast"
// - Problem Agitation: "Developers spend too much time adding features, get overwhelmed, and quit." (not about OpenUser at all)
// - Features: "OpenUser has user auth, Stripe, emails all set up for you"
const Problem = () => {
  return (
